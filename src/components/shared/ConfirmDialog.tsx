...
const ConfirmDialog = (props: ConfirmDialogProps) => {
    ...
    return (
        <Dialog contentClassName="pb-0 px-0" onClose={handleCancel} {...rest}>
            ...
            <div className="px-6 py-3 bg-gray-100 dark:bg-gray-700 rounded-bl-2xl rounded-br-2xl dark:text-gray-50">
