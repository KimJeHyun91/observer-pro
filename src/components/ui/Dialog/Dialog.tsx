...
const Dialog = (props: DialogProps) => {
    ...
    const contentStyle = {
        content: {
            ...
            transform: position ? 'translate(20px, -50%)' : undefined,
        },
        ...style,
    }
    ...
    const dialogClass = classNames(defaultDialogContentClass, contentClassName, { '!bg-transparent !p-0': position })
    ...
    return (
        <Modal
            ...
            overlayClassName={{
                base: classNames('dialog-overlay', overlayClassName as string, { '!bg-transparent': position }),
