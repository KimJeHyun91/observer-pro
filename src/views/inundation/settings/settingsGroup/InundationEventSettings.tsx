...
import { useInundationEventTypeList } from '@/utils/hooks/useInundation'
import { useEffect, useState } from 'react'
import { ConfirmDialog } from '@/components/shared';
import Loading from '@/components/shared/Loading';
import EventTypeIcon from '@/components/common/eventTypeIcon';
import { apiInundationEventModify } from '@/services/InundationService';
...
const InundationEventSettings = () => {
    const [isDataReady, setIsDataReady] = useState(false);
    const { eventTypeList, mutate } = useInundationEventTypeList();
    ...
    const onDialogOk = async () => {
        try {
            if (severityChange) {
                ...
                const res = await apiInundationEventModify(data);
    ...
    return (
        <>
            <ScrollBar className="max-h-[680px] ml-6">
...
export default InundationEventSettings
