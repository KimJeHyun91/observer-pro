...
import type { Camera } from './InundationCameraSetting'
import { apiRemoveCamera } from '@/services/ObserverService'
import type { ServiceType } from '@/@types/common'

/** 항상 Inundation 고정 */
const MAIN_SERVICE_NAME: ServiceType = 'inundation' as ServiceType

interface InundationCameraListProps {
    cameras: Camera[]
...
export default InundationCameraList
