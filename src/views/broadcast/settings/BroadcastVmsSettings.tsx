...
const BroadcastVmsSettings = () => {
    const { isLoading, error, data, mutate } = useObVms('broadcast');
    ...
    return (
        <>
            ...
            <BroadcastVmsList handleEdit={handleEdit} setIsEditMode={setIsEditMode} selectedRows={selectedRows} setSelectedRows={setSelectedRows} />
            <AlertDialog
...
export default BroadcastVmsSettings
