...
import { useBroadcastEventTypeList } from '@/utils/hooks/useBroadcast';
import { apiModifyEvent } from '@/services/BroadcastService';
...
const BroadcastEventSettings = () => {
    const [isDataReady, setIsDataReady] = useState(false);
    const { eventTypeList, mutate } = useBroadcastEventTypeList();
    ...
    const onDialogOk = async ()  => {
        try {
          if (severityChange) {
            ...
            const res = await apiModifyEvent(data);
...
export default BroadcastEventSettings
