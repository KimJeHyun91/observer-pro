...
import { useParkingEventTypeList } from '@/utils/hooks/useParkingArea'
import { useEffect, useState } from 'react'
import { ConfirmDialog } from '@/components/shared';
import Loading from '@/components/shared/Loading';
import { apiParkingEventModify } from '@/services/ParkingService';
import { AlertDialog } from '@/components/shared/AlertDialog';
import { EventList } from '@/@types/parking';
...
const ParkingEventSettings = () => {
    const [isDataReady, setIsDataReady] = useState(false);
    const { eventTypeList, mutate } = useParkingEventTypeList();
    ...
    const onDialogOk = async ()  => {
        try {
          if (severityChange) {
            ...
            const res = await apiParkingEventModify(data);
          ...
          if (stateChange) {
            ...
            if (key === 'use_event_type' && !newState) {
                updatedEventState.use_warning_board = newState;
                updatedEventState.use_popup = newState;
            }
...
export default ParkingEventSettings
